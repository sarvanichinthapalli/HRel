...
class ResNet50(nn.Module,Network,PruningMethod):
    def __init__(self,n_iterations, compress_rate, num_classes=1000):
        ...
        #self.initialize()
        '''self.sigmas = th.zeros((52, n_iterations)).cuda() #48 convs + 4 downsamples
        self.MI = th.zeros((n_iterations, 52,2)).cuda()
        self.sigmas_fixed=th.zeros((52)).cuda()
...
def resnet_50(n_iterations,compress_rate):
    return ResNet50(n_iterations,compress_rate=compress_rate)
